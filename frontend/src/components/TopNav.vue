...
const items = [
  { to: '/', name: 'home', label: 'Início' },
  { to: '/programa', name: 'program', label: 'Programa' },
  { to: '/meu-horario', name: 'my-schedule', label: 'Meu Horário' },
  { to: '/anuncios', name: 'announcements', label: 'Avisos' },
  { to: '/mais', name: 'more', label: 'Mais' },
];
