...
const session = computed(() => program.sessionById(route.params.id as string));
</script>

<template>
  <div class="max-w-2xl mx-auto px-4 pt-6 pb-10 md:px-8">
    <NuxtLink to="/programa" class="inline-flex items-center gap-1 text-sm text-slate-500 mb-4">
